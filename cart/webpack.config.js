// Webpack config for the Cart remote (port 3002).
// Exposes cart UI components and consumes the host's shared store.
...
module.exports = {
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      ...
      // Other apps will import it via `cart@http://.../remoteEntry.js` in their `remotes`.
      name: "cart",
